...
@test AlGeo.bladeIndex(e1e3) == [[1,3]]
@test AlGeo.bladeScalar(e1) == 1.0
@test AlGeo.bladeScalar(e1*5.3) == 5.3
...
@test AlGeo.basisScalarProduct(e1,e2) == 0
@test AlGeo.basisScalarProduct(e2,e2) == 1
@test_throws "This operation must be executed with basis blades." AlGeo.basisScalarProduct(e1e2,e2)
@test_throws "This operation must be executed with basis blades." AlGeo.basisScalarProduct(e1,id)
@test e1*e2 == AlGeo.bladeGeometricProduct(e1,e2)
@test e3*e1 == -e1e3
